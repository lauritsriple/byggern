...
void static menu_create(void){
	mainMenu= menu_new("Lightning Solenoid!",NULL,7);
	mainMenu->childMenus[0]= menu_new("Ping Pong",NULL,3);
	mainMenu->childMenus[0]->childMenus[0]= menu_new("Play the game",game_start,0);
	mainMenu->childMenus[0]->childMenus[1]= menu_new("See highscores",game_highscore,0);
	mainMenu->childMenus[0]->childMenus[2]=menu_new("Play AT162",game_AT,0);
